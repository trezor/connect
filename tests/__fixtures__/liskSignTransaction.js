export default {
    ...
    tests: [
        ...
        {
            description: 'sign tx transfer with data',
            params: {
                path: "m/44'/134'/0'/0'",
                transaction: {
                    amount: '10000000',
        ...
        {
            description: 'sign tx second signature',
            params: {
                path: "m/44'/134'/0'/0'",
                transaction: {
                    amount: '0',
        ...
        {
            description: 'sign tx delegate registration',
            params: {
                path: "m/44'/134'/0'/0'",
                transaction: {
                    amount: '0',
        ...
        {
            description: 'sing tx cast votes',
            params: {
                path: "m/44'/134'/0'/0'",
                transaction: {
                    amount: '0',
        ...
        {
            description: 'sign multisignature',
            params: {
                path: "m/44'/134'/0'/0'",
                transaction: {
                    amount: '0',
