...
declare class ChromeUdp {
    create: (
        properties: ChromeUdpProperties,
        callback: (info: ChromeUdpCreateInfo) => void,
    ) => void;
...
declare class ChromeAppWindow {
    create: (
        url: string,
        options: { innerBounds: ChromeBoundsSpecification },
        callback: (createdWindow: ChromeAppWindow) => void,
    ) => void;
