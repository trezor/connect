...
declare function F_KinGetAddress(params: (P.$Common & KIN.$KinGetAddress)): Promise<KIN.KinGetAddress$>;
declare function F_KinGetAddress(params: (P.$Common & { bundle: Array<KIN.$KinGetAddress> })): Promise<KIN.KinGetAddress$$>;
export type KinGetAddress = typeof F_KinGetAddress;

export type KinSignTransaction = (KIN.$KinSignTransaction) => Promise<KIN.KinSignTransaction$>;
