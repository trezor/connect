...
const signStakeRegistration = () => {
    const inputs = [
        SAMPLE_INPUTS['shelley_input'],
    ];
    const outputs = [SAMPLE_OUTPUTS['simple_shelley_output']];
    const certificates = [SAMPLE_CERTIFICATES['stake_registration']];
...
const signStakeRegistrationAndDelegation = () => {
    const inputs = [
        SAMPLE_INPUTS['shelley_input'],
    ];
    const outputs = [SAMPLE_OUTPUTS['simple_shelley_output']];
...
const signStakeDeregistration = () => {
    const inputs = [
        SAMPLE_INPUTS['shelley_input'],
    ];
    const outputs = [SAMPLE_OUTPUTS['simple_shelley_output']];
    const certificates = [SAMPLE_CERTIFICATES['stake_deregistration']];
...
const signStakeDeregistrationAndWithdrawal = () => {
    const inputs = [
        SAMPLE_INPUTS['shelley_input'],
    ];
    const outputs = [SAMPLE_OUTPUTS['simple_shelley_output']];
    const certificates = [SAMPLE_CERTIFICATES['stake_deregistration']];
    const withdrawals = [SAMPLE_WITHDRAWAL];
...
const signMetadata = () => {
    ...
    const outputs = [SAMPLE_OUTPUTS['simple_shelley_output']];
    const metadata = '';
...
export const cardanoSignTransaction = () => {
    const availableSubtests = {
        ...
        signStakeRegistration,
        signStakeRegistrationAndDelegation,
        signStakeDeregistration,
        signStakeDeregistrationAndWithdrawal,
        signMetadata,
        signTestnet,
    };
    return {
