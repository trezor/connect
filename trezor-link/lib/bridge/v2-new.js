...
var parse_protocol_new_1 = require("../lowlevel/protobuf/parse_protocol-new");
var receive_new_1 = require("../lowlevel/receive-new");
...
var BridgeTransport = /** @class */ (function () {
    ...
    BridgeTransport.prototype.configure = function (signedData) {
        return __awaiter(this, void 0, void 0, function () {
            var messages;
            return __generator(this, function (_a) {
                messages = (0, parse_protocol_new_1.parseConfigure)(signedData);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        outData = (0, send_new_1.buildOne)(messages, name, data).toString("hex");
                        return [4 /*yield*/, this._post({
                    ...
                    case 1:
                        ...
                        jsonData = (0, receive_new_1.receiveOne)(messages, new Buffer(resData, "hex"));
